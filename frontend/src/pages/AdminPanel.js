...
const AdminPanel = () => {
  ...
  const deleteProject = async (id) => {
    ...
    try {
      ...
      await axios.delete(`https://govpro-web-backend-gely.onrender.com/api/projects/${id}`, {
  ...
  const toggleApproval = async (id, currentStatus) => {
    try {
      const updated = await axios.put(`https://govpro-web-backend-gely.onrender.com/api/projects/${id}/approve`, {
